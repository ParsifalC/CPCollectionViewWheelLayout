#
#  Be sure to run `pod spec lint CPCollectionViewWheelLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of CPCollectionViewWheelLayout in Markdown format.
  ...
  s.source_files  = "CollectionViewWheelLayoutDemo/CollectionViewWheelLayoutDemo/CPCollectionViewWheelLayout.{h,m}"
